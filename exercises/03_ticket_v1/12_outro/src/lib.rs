...
pub struct Order { // the struct is public
    product_name: String,
    quantity: u32,
    unit_price: u32,
}
...
impl Order {
    pub fn new(product_name: String, quantity: u32, unit_price: u32) -> Self {
        ...
        Order::product_name_300(&product_name);
    ...
    // function for product name that can't be longer than 300 bytes
    fn product_name_300(product_name: &str) {
